...
public class FavouriteActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public List<String> getSaveFavourite()
    {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("Users").child(uid).child("favourite").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot d : dataSnapshot.getChildren())
                {
                    ...
                    Log.d("oooooo", "onDataChange: " + id);
                    //getDataFavouriteFromServer(sID);
                }
                sID.add(id);
            }

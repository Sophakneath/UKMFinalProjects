...
public class EditPostsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                getActionBarHeight());
        Log.d("ooooooo", "onCreate: " + getActionBarHeight());
        actionBar.setLayoutParams(lp);

        Intent intent = getIntent();
        myPost = (ESCCI) intent.getSerializableExtra("posts");
        updateUI();
    ...
    private void updateUI() {
        ...
        etName.setText(myPost.getName());
        etOrganizer.setText(myPost.getOrganizer());
        categories.setSelection(list.indexOf(myPost.getMode()));
        getImage(picture, myPost.getImage(), this);

        switch(myPost.getMode())
        {
            case "Career": updateCareerAndCompetition(); break;
            case "Competition": updateCareerAndCompetition(); break;
            case "Events": updateEvents(); break;
            case "Internship": updateInternship(); break;
            case "Scholarship": updateScholarship(); break;
        }
    }

    public void updateCareerAndCompetition()
    {
    ...
    {
        etEWhen.setText(myPost.getDate());
        etEFrom.setText(myPost.geteTimeStart());
        etEUntil.setText(myPost.geteTimeEnd());
        ...
        {
            chFee.setChecked(true);
            chFree.setChecked(false);
            etEFee.setText(myPost.geteFee()+"");
        }
        else
        {
            chFree.setChecked(true);
            chFee.setChecked(false);
        }
    }

    public void updateInternship()
    {
        etIFrom.setText(myPost.getStartDate());
    ...
    public void updateScholarship()
    {
        ...
        String[] degrees = myPost.getRandom().split(" ");
        for(String a:degrees) d.add(a);
        if(d.contains("Bachelor")) chBachelor.setChecked(true);
        if(d.contains("Master")) chMaster.setChecked(true);
        if(d.contains("PHD")) chPHD.setChecked(true);
    ...
    public void postExecute()
    {
        ...
        if(pathImage == null) image = this.myPost.getImage();
                ...
                if (mUploadTask != null) {
                    ...
                    mUploadTask.addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(EditPostsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            closeControl(true);
                        }
                    });
                }
    ...
    public void saveToServer(ESCCI myPost)
    {
        ...
        mDatabase.child("Posting").child(myPost.getMode()).child(id).setValue(myPost).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                bundle.putSerializable("result", myPost);
    ...
    public void timePicker(EditText a)
    {
        ...
        mTimePicker = new TimePickerDialog(EditPostsActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    {
        new DatePickerDialog(EditPostsActivity.this, dates, myCalendar
